...
From the title and script itself, pretty evident and self explanatory this was AES CBC. \
The nc would try to decrypt a plaintext you send and return Error or Looks Good. \
Since most likely an error on decrypting could only mean `wrong padding`. \
